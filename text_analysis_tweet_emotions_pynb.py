# -*- coding: utf-8 -*-
"""text_Analysis_tweet_emotions.pynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/124OL3XCFpZGYMtccmJ74V6z5XtAj-OCH
"""
...
Understand the structure of the data to decide the next steps for text analysis.
"""
...
Clean the text data to make it suitable for analysis (e.g., remove special characters, stopwords, convert to lowercase).
"""
...
# Apply preprocessing to the text column (adjust column name as needed)
if 'content' in data.columns:  # Replace 'content' with the name of your text col
    data['cleaned_text'] = data['content'].apply(preprocess_text)

# Display cleaned text
print(data[['content', 'cleaned_text']].head())

"""3.Use Pre-Trained Models with Lower Complexity
Instead of BERT, you can use a lighter model like DistilBERT (a distilled version of BERT) for sentiment analysis.
"""
...
Extract important keywords from the text using spaCy.
"""
...
print(f"Predicted Sentiment: {new_predictions}")
