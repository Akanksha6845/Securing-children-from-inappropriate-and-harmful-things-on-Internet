# -*- coding: utf-8 -*-
"""training.processed.noemoticon.ipynb
...
data = pd.read_csv('training.processed.noemoticon.csv', encoding='latin-1')
...
input_csv = 'training.processed.noemoticon.csv'
output_csv = 'cleaned_training.processed.noemoticon.csv'  # Replace with your desired output CSV file
...
if 'user' not in df.columns:
    raise ValueError("The CSV file must have a 'user' column with text data to clean.")
...
df['Cleaned_Text'] = df['user'].apply(remove_punctuation)
...
# Input and output file paths
input_csv = 'cleaned_training.processed.noemoticon.csv'   # Replace with your input CSV file
output_csv = 'tokenized_cleaned_training.processed.noemoticon.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'tokenized_cleaned_training.processed.noemoticon.csv'   # Replace with your input CSV file
output_csv = 'stopwords_tokenized_cleaned_training.processed.noemoticon.csv'  # Replace with your desired output CSV file
...
input_csv = 'stopwords_tokenized_cleaned_training.processed.noemoticon.csv'   # Replace with your input CSV file
output_csv = 'stemmed_stopwords_tokenized_cleaned_training.processed.noemoticon.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stemmed_stopwords_tokenized_cleaned_training.processed.noemoticon.csv'   # Replace with your input CSV file
output_csv = 'lemmatized_stemmed_stopwords_tokenized_cleaned_training.processed.noemoticon.csv'  # Replace with your desired output CSV file
