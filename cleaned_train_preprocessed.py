# -*- coding: utf-8 -*-
"""cleaned_train_preprocessed.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1kOpI7CuIpj77j60vh29yCYfybR3vcn52
"""
...
data = pd.read_csv('cleaned_train_preprocessed.csv')
...
input_csv = 'cleaned_train_preprocessed.csv'   # Replace with your input CSV file
output_csv = 'cleaned_cleaned_train_preprocessed.csv'  # Replace with your desired output CSV file
...
if 'comment_text' not in df.columns:
    raise ValueError("The CSV file must have a 'comment_text' column with text data to clean.")
...
df['Cleaned_Text'] = df['comment_text'].apply(remove_punctuation)
...
# Input and output file paths
input_csv = 'cleaned_cleaned_train_preprocessed.csv'   # Replace with your input CSV file
output_csv = 'tokenize_cleaned_cleaned_train_preprocessed.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'tokenize_cleaned_cleaned_train_preprocessed.csv'   # Replace with your input CSV file
output_csv = 'stopwords_tokenize_cleaned_cleaned_train_preprocessed.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stopwords_tokenize_cleaned_cleaned_train_preprocessed.csv'   # Replace with your input CSV file
output_csv = 'stemmed_stopwords_tokenize_cleaned_cleaned_train_preprocessed.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stemmed_stopwords_tokenize_cleaned_cleaned_train_preprocessed.csv'   # Replace with your input CSV file
output_csv = 'lemmatized_stemmed_stopwords_tokenize_cleaned_cleaned_train_preprocessed.csv'  # Replace with your desired output CSV file
