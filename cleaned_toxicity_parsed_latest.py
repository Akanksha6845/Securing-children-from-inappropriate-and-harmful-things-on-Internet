...
Original file is located at
    https://colab.research.google.com/drive/1DYQAvfXx9pO5mbA3ENRYsJzhMWgCQTnV
"""
...
# Function to perform stemming with error handling
def stem_text(text):
    words = word_tokenize(str(text))  # Tokenize the text
    stemmed_words = []
    for word in words:
        try:
            ...
            print(f"Skipping word '{word}' due to RecursionError.")
