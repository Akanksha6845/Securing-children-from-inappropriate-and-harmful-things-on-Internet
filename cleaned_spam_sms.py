# -*- coding: utf-8 -*-
"""cleaned_Spam_SMS.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1jhYSirr_aTpHxfPY1zj-BMub0UADrQEe
"""
...
data = pd.read_csv('cleaned_Spam_SMS.csv')
...
input_csv = 'cleaned_Spam_SMS.csv'   # Replace with your input CSV file
output_csv = 'cleaned_cleaned_Spam_SMS.csv'  # Replace with your desired output CSV file
...
if 'Message' not in df.columns:
    raise ValueError("The CSV file must have a 'Message' column with text data to clean.")
...
df['Cleaned_Text'] = df['Message'].apply(remove_punctuation)
...
# Input and output file paths
input_csv = 'cleaned_cleaned_Spam_SMS.csv'   # Replace with your input CSV file
output_csv = 'tokenize_cleaned_cleaned_Spam_SMS.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'tokenize_cleaned_cleaned_Spam_SMS.csv'   # Replace with your input CSV file
output_csv = 'stopwords_tokenize_cleaned_cleaned_Spam_SMS.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stopwords_tokenize_cleaned_cleaned_Spam_SMS.csv'   # Replace with your input CSV file
output_csv = 'stemmed_stopwords_tokenize_cleaned_cleaned_Spam_SMS.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stemmed_stopwords_tokenize_cleaned_cleaned_Spam_SMS.csv'   # Replace with your input CSV file
output_csv = 'lemmatized_stemmed_stopwords_tokenize_cleaned_cleaned_Spam_SMS.csv'  # Replace with your desired output CSV file
