# -*- coding: utf-8 -*-
"""cleaned_netflix_fb_sentences (1).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1OR-cLohdgu42asD2NpXzkl6hmdFM7f_h
"""
...
data = pd.read_csv('cleaned_netflix_fb_sentences (1).csv')
...
input_csv = 'cleaned_netflix_fb_sentences (1).csv'   # Replace with your input CSV file
output_csv = 'cleaned_cleaned_netflix_fb_sentences (1).csv'  # Replace with your desired output CSV file
...
if 'Sentence' not in df.columns:
    raise ValueError("The CSV file must have a 'Sentence' column with text data to clean.")
...
df['Cleaned_Text'] = df['Sentence'].apply(remove_punctuation)
...
# Input and output file paths
input_csv = 'cleaned_cleaned_netflix_fb_sentences (1).csv'   # Replace with your input CSV file
output_csv = 'tokenize_cleaned_cleaned_netflix_fb_sentences (1).csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'tokenize_cleaned_cleaned_netflix_fb_sentences (1).csv'   # Replace with your input CSV file
output_csv = 'stopwords_tokenize_cleaned_cleaned_netflix_fb_sentences (1).csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stopwords_tokenize_cleaned_cleaned_netflix_fb_sentences (1).csv'   # Replace with your input CSV file
output_csv = 'stemmed_stopwords_tokenize_cleaned_cleaned_netflix_fb_sentences (1).csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stemmed_stopwords_tokenize_cleaned_cleaned_netflix_fb_sentences (1).csv'   # Replace with your input CSV file
output_csv = 'lemmatized_stemmed_stopwords_tokenize_cleaned_cleaned_netflix_fb_sentences (1).csv'  # Replace with your desired output CSV file
