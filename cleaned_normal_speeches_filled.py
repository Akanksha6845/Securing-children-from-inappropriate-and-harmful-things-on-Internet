# -*- coding: utf-8 -*-
"""cleaned_Normal_Speeches_Filled.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1UKkseMn2HvuKtKmVgfBs3N0_gtdV5Kiv
"""
...
data = pd.read_csv('cleaned_Normal_Speeches_Filled.csv')
...
input_csv = 'cleaned_Normal_Speeches_Filled.csv'   # Replace with your input CSV file
output_csv = 'cleaned_cleaned_Normal_Speeches_Filled.csv'  # Replace with your desired output CSV file
...
if 'full_text' not in df.columns:
    raise ValueError("The CSV file must have a 'full_text' column with text data to clean.")
...
df['Cleaned_Text'] = df['full_text'].apply(remove_punctuation)
...
# Input and output file paths
input_csv = 'cleaned_cleaned_Normal_Speeches_Filled.csv'   # Replace with your input CSV file
output_csv = 'tokenize_cleaned_cleaned_Normal_Speeches_Filled.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'tokenize_cleaned_cleaned_Normal_Speeches_Filled.csv'   # Replace with your input CSV file
output_csv = 'stopwords_tokenize_cleaned_cleaned_Normal_Speeches_Filled.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stopwords_tokenize_cleaned_cleaned_Normal_Speeches_Filled.csv'   # Replace with your input CSV file
output_csv = 'stemmed_stopwords_tokenize_cleaned_cleaned_Normal_Speeches_Filled.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stemmed_stopwords_tokenize_cleaned_cleaned_Normal_Speeches_Filled.csv'   # Replace with your input CSV file
output_csv = 'lemmatized_stemmed_stopwords_tokenize_cleaned_cleaned_Normal_Speeches_Filled.csv'  # Replace with your desired output CSV file
