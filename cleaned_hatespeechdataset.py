# -*- coding: utf-8 -*-
"""Cleaned_HateSpeechDataset.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1IJ79OtyQxBdgJ94axfRMlGndKV6VgIz8
"""
...
data = pd.read_csv('Cleaned_HateSpeechDataset.csv')
...
input_csv = 'Cleaned_HateSpeechDataset.csv'   # Replace with your input CSV file
output_csv = 'cleaned_Cleaned_HateSpeechDataset.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'cleaned_Cleaned_HateSpeechDataset.csv'   # Replace with your input CSV file
output_csv = 'tokenize_cleaned_Cleaned_HateSpeechDataset.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'tokenize_cleaned_Cleaned_HateSpeechDataset.csv'   # Replace with your input CSV file
output_csv = 'stopwords_tokenize_cleaned_Cleaned_HateSpeechDataset.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stopwords_tokenize_cleaned_Cleaned_HateSpeechDataset.csv'   # Replace with your input CSV file
output_csv = 'stemmed_stopwords_tokenize_cleaned_Cleaned_HateSpeechDataset.csv'  # Replace with your desired output CSV file
...
# Function to perform stemming, handling potential recursion errors
def stem_text(text):
    try:
        words = word_tokenize(str(text))  # Tokenize the text
        ...
        # If RecursionError occurs, return the original text as is
        print(f"RecursionError encountered for text: {text}")
        return text
...
# Input and output file paths
input_csv = 'stemmed_stopwords_tokenize_cleaned_Cleaned_HateSpeechDataset.csv'   # Replace with your input CSV file
output_csv = 'lemmatized_stemmed_stopwords_tokenize_cleaned_Cleaned_HateSpeechDataset.csv'  # Replace with your desired output CSV file
