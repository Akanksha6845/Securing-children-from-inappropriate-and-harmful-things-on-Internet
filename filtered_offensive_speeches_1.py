# -*- coding: utf-8 -*-
"""Filtered_Offensive_Speeches_1.ipynb
...
data = pd.read_csv('Filtered_Offensive_Speeches_1.csv')
...
input_csv = 'Filtered_Offensive_Speeches_1.csv'
output_csv = 'cleaned_Filtered_Offensive_Speeches_1.csv'  # Replace with your desired output CSV file
...
if 'url' not in df.columns:
    raise ValueError("The CSV file must have a 'url' column with text data to clean.")
...
df['Cleaned_Text'] = df['url'].apply(remove_punctuation)
...
# Input and output file paths
input_csv = 'cleaned_Filtered_Offensive_Speeches_1.csv'   # Replace with your input CSV file
output_csv = 'tokenized_cleaned_Filtered_Offensive_Speeches_1.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'tokenized_cleaned_Filtered_Offensive_Speeches_1.csv'   # Replace with your input CSV file
output_csv = 'stopwords_tokenized_cleaned_Filtered_Offensive_Speeches_1.csv'  # Replace with your desired output CSV file
...
input_csv = 'stopwords_tokenized_cleaned_Filtered_Offensive_Speeches_1.csv'   # Replace with your input CSV file
output_csv = 'stemmed_stopwords_tokenized_cleaned_Filtered_Offensive_Speeches_1.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stemmed_stopwords_tokenized_cleaned_Filtered_Offensive_Speeches_1.csv'   # Replace with your input CSV file
output_csv = 'lemmatized_stemmed_stopwords_tokenized_cleaned_Filtered_Offensive_Speeches_1.csv'  # Replace with your desired output CSV file
