# -*- coding: utf-8 -*-
"""Cleaned_Hate_Speeches_2.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1lzCwQnw1jF6QXI36m1n_efazUzhq41RC
"""
...
data = pd.read_csv('Cleaned_Hate_Speeches_2.csv')
...
input_csv = 'Cleaned_Hate_Speeches_2.csv'   # Replace with your input CSV file
output_csv = 'cleaned_Cleaned_Hate_Speeches_2.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'cleaned_Cleaned_Hate_Speeches_2.csv'   # Replace with your input CSV file
output_csv = 'tokenize_cleaned_Cleaned_Hate_Speeches_2.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'tokenize_cleaned_Cleaned_Hate_Speeches_2.csv'   # Replace with your input CSV file
output_csv = 'stopwords_tokenize_cleaned_Cleaned_Hate_Speeches_2.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stopwords_tokenize_cleaned_Cleaned_Hate_Speeches_2.csv'   # Replace with your input CSV file
output_csv = 'stemmed_stopwords_tokenize_cleaned_Cleaned_Hate_Speeches_2.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stemmed_stopwords_tokenize_cleaned_Cleaned_Hate_Speeches_2.csv'   # Replace with your input CSV file
output_csv = 'lemmatized_stemmed_stopwords_tokenize_cleaned_Cleaned_Hate_Speeches_2.csv'  # Replace with your desired output CSV file
