# -*- coding: utf-8 -*-
"""Cleaned_CBTweets.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1qeYYOC32JL3XiYXl_-zh05dL0J9uzSmt
"""
...
data = pd.read_csv('Cleaned_CBTweets.csv')
...
input_csv = 'Cleaned_CBTweets.csv'   # Replace with your input CSV file
output_csv = 'cleaned_Cleaned_CBTweets.csv'  # Replace with your desired output CSV file
...
df['Cleaned_Text'] = df['tweet_text'].apply(remove_punctuation)
...
# Input and output file paths
input_csv = 'cleaned_Cleaned_CBTweets.csv'   # Replace with your input CSV file
output_csv = 'tokenize_cleaned_Cleaned_CBTweets.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'tokenize_cleaned_Cleaned_CBTweets.csv'   # Replace with your input CSV file
output_csv = 'stopwords_tokenize_cleaned_Cleaned_CBTweets.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stopwords_tokenize_cleaned_Cleaned_CBTweets.csv'   # Replace with your input CSV file
output_csv = 'stemmed_stopwords_tokenize_cleaned_Cleaned_CBTweets.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stemmed_stopwords_tokenize_cleaned_Cleaned_CBTweets.csv'   # Replace with your input CSV file
output_csv = 'lemmatized_stemmed_stopwords_tokenize_cleaned_Cleaned_CBTweets.csv'  # Replace with your desired output CSV file
