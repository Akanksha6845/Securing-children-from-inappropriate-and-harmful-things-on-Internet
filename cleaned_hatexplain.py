# -*- coding: utf-8 -*-
"""Cleaned_hateXplain.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1UKOLQ331IZoVtpFvwVneNy3JCV_bHxA6
"""
...
data = pd.read_csv('Cleaned_hateXplain.csv')
...
input_csv = 'Cleaned_hateXplain.csv'   # Replace with your input CSV file
output_csv = 'cleaned_Cleaned_hateXplain.csv'  # Replace with your desired output CSV file

# Load the dataset
df = pd.read_csv(input_csv)

# Check if the column exists (assuming the column is named 'Text')
if 'post_tokens' not in df.columns:
    raise ValueError("The CSV file must have a 'post_tokens' column with text data to clean.")
...
df['Cleaned_Text'] = df['post_tokens'].apply(remove_punctuation)
...
# Input and output file paths
input_csv = 'cleaned_Cleaned_hateXplain.csv'   # Replace with your input CSV file
output_csv = 'tokenize_cleaned_Cleaned_hateXplain.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'tokenize_cleaned_Cleaned_hateXplain.csv'   # Replace with your input CSV file
output_csv = 'stopwords_tokenize_cleaned_Cleaned_hateXplain.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stopwords_tokenize_cleaned_Cleaned_hateXplain.csv'   # Replace with your input CSV file
output_csv = 'stemmed_stopwords_tokenize_cleaned_Cleaned_hateXplain.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stemmed_stopwords_tokenize_cleaned_Cleaned_hateXplain.csv'   # Replace with your input CSV file
output_csv = 'lemmatized_stemmed_stopwords_tokenize_cleaned_Cleaned_hateXplain.csv'  # Replace with your desired output CSV file
