# -*- coding: utf-8 -*-
"""cleaned_toxicity_parsed_latest.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1SXp5CraTFJeJZvf9nWMt6Fb4xhMONn77
"""
...
data = pd.read_csv('cleaned_toxicity_parsed_latest.csv')
...
input_csv = 'cleaned_toxicity_parsed_latest.csv'   # Replace with your input CSV file
output_csv = 'cleaned_cleaned_toxicity_parsed_latest.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'cleaned_cleaned_toxicity_parsed_latest.csv'   # Replace with your input CSV file
output_csv = 'tokenize_cleaned_cleaned_toxicity_parsed_latest.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'tokenize_cleaned_cleaned_toxicity_parsed_latest.csv'   # Replace with your input CSV file
output_csv = 'stopwords_tokenize_cleaned_cleaned_toxicity_parsed_latest.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stopwords_tokenize_cleaned_cleaned_toxicity_parsed_latest.csv'   # Replace with your input CSV file
output_csv = 'stemmed_stopwords_tokenize_cleaned_cleaned_toxicity_parsed_latest.csv'  # Replace with your desired output CSV file
...
def stem_text(text):
    ...
    for word in words:
        try:
            # Attempt to stem the word, it might raise RecursionError
            stemmed_words.append(stemmer.stem(word))
        except RecursionError:
            # If RecursionError occurs, keep the original word
...
# Input and output file paths
input_csv = 'stemmed_stopwords_tokenize_cleaned_cleaned_toxicity_parsed_latest.csv'   # Replace with your input CSV file
output_csv = 'lemmatized_stemmed_stopwords_tokenize_cleaned_cleaned_toxicity_parsed_latest.csv'  # Replace with your desired output CSV file
