# -*- coding: utf-8 -*-
"""aggression_parsed_dataset.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/12AtcMcD4ObOkvoMbajVTjsJf5jlQuzbs
"""
...
input_csv = 'aggression_parsed_dataset.csv'   # Replace with your input CSV file
output_csv = 'cleaned_aggression_parsed_dataset.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'cleaned_aggression_parsed_dataset.csv'   # Replace with your input CSV file
output_csv = 'tokenize_cleaned_aggression_parsed_dataset.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'tokenize_cleaned_aggression_parsed_dataset.csv'   # Replace with your input CSV file
output_csv = 'stopwords_tokenize_cleaned_aggression_parsed_dataset.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stopwords_tokenize_cleaned_aggression_parsed_dataset.csv'   # Replace with your input CSV file
output_csv = 'stemmed_stopwords_tokenize_cleaned_aggression_parsed_dataset.csv'  # Replace with your desired output CSV file
...
# Function to perform stemming with recursion limit handling
def stem_text(text):
    try:
        words = word_tokenize(str(text))  # Tokenize the text
        ...
        # Handle the recursion error, e.g., skip the word or return the original text
        print(f"RecursionError encountered while stemming: {text}")
        return text  # Or return an empty string, or skip the word
...
# Input and output file paths
input_csv = 'stemmed_stopwords_tokenize_cleaned_aggression_parsed_dataset.csv'   # Replace with your input CSV file
output_csv = 'lemmatized_stemmed_stopwords_tokenize_cleaned_aggression_parsed_dataset.csv'  # Replace with your desired output CSV file
