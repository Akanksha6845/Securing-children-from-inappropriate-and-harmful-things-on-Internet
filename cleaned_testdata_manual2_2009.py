# -*- coding: utf-8 -*-
"""cleaned_testdata_manual2_2009.ipynb
...
data = pd.read_csv('cleaned_testdata_manual2_2009.csv')
...
if '@stellargirl I loooooooovvvvvveee my Kindle2. Not that the DX is cool, but the 2 is fantastic in its own right.' not in df.columns:
    raise ValueError("The CSV file must have a '@stellargirl I loooooooovvvvvveee my Kindle2. Not that the DX is cool, but the 2 is fantastic in its own right.' column with text data to clean.")
...
df['Cleaned_Text'] = df['@stellargirl I loooooooovvvvvveee my Kindle2. Not that the DX is cool, but the 2 is fantastic in its own right.'].apply(remove_punctuation)
