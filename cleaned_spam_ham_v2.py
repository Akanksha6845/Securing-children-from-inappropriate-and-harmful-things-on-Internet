...
data = pd.read_csv('cleaned_spam_ham_v2.csv')
...
input_csv = 'cleaned_spam_ham_v2.csv'   # Replace with your input CSV file
output_csv = 'cleaned_cleaned_spam_ham_v2.csv'  # Replace with your desired output CSV file
...
if 'v2' not in df.columns:
    raise ValueError("The CSV file must have a 'v2' column with text data to clean.")
...
df['Cleaned_Text'] = df['v2'].apply(remove_punctuation)
...
# Input and output file paths
input_csv = 'cleaned_cleaned_spam_ham_v2.csv'   # Replace with your input CSV file
output_csv = 'tokenized_cleaned_cleaned_spam_ham_v2.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'tokenized_cleaned_cleaned_spam_ham_v2.csv'   # Replace with your input CSV file
output_csv = 'stopwords_tokenized_cleaned_cleaned_spam_ham_v2.csv'  # Replace with your desired output CSV file
...
input_csv = 'stopwords_tokenized_cleaned_cleaned_spam_ham_v2.csv'   # Replace with your input CSV file
output_csv = 'stemmed_stopwords_tokenized_cleaned_cleaned_spam_ham_v2.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stopwords_tokenized_cleaned_cleaned_spam_ham_v2.csv'   # Replace with your input CSV file
output_csv = 'lemmatized_stopwords_tokenized_cleaned_cleaned_spam_ham_v2.csv'  # Replace with your desired output CSV file
