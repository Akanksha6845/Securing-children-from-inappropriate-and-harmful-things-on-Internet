# -*- coding: utf-8 -*-
"""Cleaned_Combined_Data.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/13P9Eum21ubHdHkPrlqPNYWGJ9gXsbcPd
"""
...
input_csv = 'Cleaned_Combined_Data.csv'   # Replace with your input CSV file
output_csv = 'cleaned_Cleaned_Combined_Data.csv'  # Replace with your desired output CSV file
...
if 'statement' not in df.columns:
    raise ValueError("The CSV file must have a 'statement' column with text data to clean.")
...
df['Cleaned_Text'] = df['statement'].apply(remove_punctuation)
...
# Input and output file paths
input_csv = 'cleaned_Cleaned_Combined_Data.csv'   # Replace with your input CSV file
output_csv = 'tokenize_cleaned_Cleaned_Combined_Data.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'tokenize_cleaned_Cleaned_Combined_Data.csv'   # Replace with your input CSV file
output_csv = 'stopwords_tokenize_cleaned_Cleaned_Combined_Data.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stopwords_tokenize_cleaned_Cleaned_Combined_Data.csv'   # Replace with your input CSV file
output_csv = 'stemmed_stopwords_tokenize_cleaned_Cleaned_Combined_Data.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stemmed_stopwords_tokenize_cleaned_Cleaned_Combined_Data.csv'   # Replace with your input CSV file
output_csv = 'lemmatized_stemmed_stopwords_tokenize_cleaned_Cleaned_Combined_Data.csv'  # Replace with your desired output CSV file
