...
data = pd.read_csv('cleaned_t_nosubject.csv')
...
input_csv = 'cleaned_t_nosubject.csv'
output_csv = 'cleaned_cleaned_t_nosubject.csv'  # Replace with your desired output CSV file
...
if 'Answer' not in df.columns:
    raise ValueError("The CSV file must have a 'Answer' column with text data to clean.")
...
df['Cleaned_Text'] = df['Answer'].apply(remove_punctuation)
...
# Input and output file paths
input_csv = 'cleaned_cleaned_t_nosubject.csv'   # Replace with your input CSV file
output_csv = 'tokenized_cleaned_cleaned_t_nosubject.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'tokenized_cleaned_cleaned_t_nosubject.csv'   # Replace with your input CSV file
output_csv = 'stopwords_tokenized_cleaned_cleaned_t_nosubject.csv'  # Replace with your desired output CSV file
...
input_csv = 'stopwords_tokenized_cleaned_cleaned_t_nosubject.csv'   # Replace with your input CSV file
output_csv = 'stemmed_stopwords_tokenized_cleaned_cleaned_t_nosubject.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stemmed_stopwords_tokenized_cleaned_cleaned_t_nosubject.csv'   # Replace with your input CSV file
output_csv = 'lemmatized_stemmed_stopwords_tokenized_cleaned_cleaned_t_nosubject.csv'  # Replace with your desired output CSV file
