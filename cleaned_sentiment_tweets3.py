...
Original file is located at
    https://colab.research.google.com/drive/1svLDT3VwMsbPuUBUnkKfBnJ_kUvKuDlD
"""
...
input_csv = 'cleaned_sentiment_tweets3.csv'   # Replace with your input CSV file
...
if 'message to examine' not in df.columns:
    raise ValueError("The CSV file must have a 'message to examine' column with text data to clean.")
...
df['Cleaned_Text'] = df['message to examine'].apply(remove_punctuation)
...
output_csv = 'tokenize_cleaned_cleaned_sentiment_tweets3.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'tokenize_cleaned_cleaned_sentiment_tweets3.csv'   # Replace with your input CSV file
output_csv = 'stopwords_tokenize_cleaned_cleaned_sentiment_tweets3.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stopwords_tokenize_cleaned_cleaned_sentiment_tweets3.csv'   # Replace with your input CSV file
output_csv = 'stemmed_stopwords_tokenize_cleaned_cleaned_sentiment_tweets3.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stemmed_stopwords_tokenize_cleaned_cleaned_sentiment_tweets3.csv'   # Replace with your input CSV file
output_csv = 'lemmatized_stemmed_stopwords_tokenize_cleaned_cleaned_sentiment_tweets3.csv'  # Replace with your desired output CSV file
