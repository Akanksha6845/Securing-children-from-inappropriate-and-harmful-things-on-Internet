# -*- coding: utf-8 -*-
"""cleaned_sentiment_tweets3.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Bbbhsltkpd236uxP1FQ0ULKhbDwnJKvt
"""
...
data = pd.read_csv('cleaned_sentiment_tweets3.csv')
...
input_csv = 'cleaned_sentiment_tweets3.csv'
output_csv = 'cleaned_cleaned_sentiment_tweets3.csv'  # Replace with your desired output CSV file

# Load the dataset
df = pd.read_csv(input_csv)

# Check if the column exists (assuming the column is named 'Text')
if 'label (depression result)' not in df.columns:
    raise ValueError("The CSV file must have a 'label (depression result)' column with text data to clean.")
...
df['Cleaned_Text'] = df['label (depression result)'].apply(remove_punctuation)
...
# Input and output file paths
input_csv = 'cleaned_cleaned_sentiment_tweets3.csv'   # Replace with your input CSV file
output_csv = 'tokenized_cleaned_cleaned_sentiment_tweets3.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'tokenized_cleaned_cleaned_sentiment_tweets3.csv'   # Replace with your input CSV file
output_csv = 'stopwords_tokenized_cleaned_cleaned_sentiment_tweets3.csv'  # Replace with your desired output CSV file
...
input_csv = 'stopwords_tokenized_cleaned_cleaned_sentiment_tweets3.csv'   # Replace with your input CSV file
output_csv = 'stemmed_stopwords_tokenized_cleaned_cleaned_sentiment_tweets3.csv'  # Replace with your desired output CSV file
...
# Input and output file paths
input_csv = 'stemmed_stopwords_tokenized_cleaned_cleaned_sentiment_tweets3.csv'   # Replace with your input CSV file
output_csv = 'lemmatized_stemmed_stopwords_tokenized_cleaned_cleaned_sentiment_tweets3.csv'  # Replace with your desired output CSV file
